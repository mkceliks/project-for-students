...
<head>
  ...
  <header><h1 class="text">-----Theory Of Computation Dersi Öğrenci Listesi-----</h1></header>
  <meta charset="UTF-8">
</head>
<body>
	<table>
	<?php 
		$sorgu = "SELECT * FROM info_toc";
	...
	<a class='edit' href='toc_guncelle.php?id=".$kayit ['info_id']."'>Düzenle</a></td>
	</tr>";	
			}
		}
		echo "</table>";
...
<button class="mainpage" type="submit" name="mainpage" onclick="location.href='toc_index.php'">Ana Sayfa</button></div>
