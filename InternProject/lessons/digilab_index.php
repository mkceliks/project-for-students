...
<html >
  <head>
    ...
    <title>Digital Design Lab. Yönetici</title>
  ...
  <body>
    ...
    <br>
     <div align="center">
      ...
      onclick="location.href='digilab_liste.php'">Göster</button>
      <br><br><br>
     </div>
     <div align="center">
      ...
      <br>
      <button class="typesubmit1" style="margin-right:20px;" type="submit" name="goster" 
      onclick="location.href='digilab_derslistesi.php'">Göster</button>
      <br><br><br>
     </div>
     <div align="center">
