...
<head>
  ...
  <header><h1 class="text">-----Digital Design Lab. Dersi Öğrenci Listesi-----</h1></header>
  <meta charset="UTF-8">
</head>
<body>
	<table>
	<?php 
		$sorgu = "SELECT * FROM info_digilab";
	...
	<a class='edit' href='digilab_guncelle.php?id=".$kayit ['info_id']."'>Düzenle</a></td>
	</tr>";	
			}
		}
		echo "</table>";
...
<button class="mainpage" type="submit" name="mainpage" onclick="location.href='digilab_index.php'">Ana Sayfa</button></div>
