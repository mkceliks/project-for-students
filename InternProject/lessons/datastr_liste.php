...
<head>
  ...
  <header><h1 class="text">-----Data Structures Dersi Öğrenci Listesi-----</h1></header>
  <meta charset="UTF-8">
</head>
<body>
	<table>
	<?php 
		$sorgu = "SELECT * FROM info_datastr";
	...
	<a class='edit' href='datastr_guncelle.php?id=".$kayit ['info_id']."'>Düzenle</a></td>
	</tr>";	
			}
		}
		echo "</table>";
...
<button class="mainpage" type="submit" name="mainpage" onclick="location.href='datastr_index.php'">Ana Sayfa</button></div>
