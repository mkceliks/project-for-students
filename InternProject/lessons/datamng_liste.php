...
<head>
  ...
  <header><h1 class="text">-----Data Management Dersi Öğrenci Listesi-----</h1></header>
  <meta charset="UTF-8">
</head>
<body>
	<table>
	<?php 
		$sorgu = "SELECT * FROM info_datamng";
	...
	<a class='edit' href='datamng_guncelle.php?id=".$kayit ['info_id']."'>Düzenle</a></td>
	</tr>";	
			}
		}
		echo "</table>";
...
<button class="mainpage" type="submit" name="mainpage" onclick="location.href='datamng_index.php'">Ana Sayfa</button></div>
