...
<head>
  ...
  <header><h1 class="text">-----Electronics Dersi Öğrenci Listesi-----</h1></header>
  <meta charset="UTF-8">
</head>
<body>
	<table>
	<?php 
		$sorgu = "SELECT * FROM info_electronics";
	...
	<a class='edit' href='electronics_guncelle.php?id=".$kayit ['info_id']."'>Düzenle</a></td>
	</tr>";	
			}
		}
		echo "</table>";
...
<button class="mainpage" type="submit" name="mainpage" onclick="location.href='electronics_index.php'">Ana Sayfa</button></div>
