...
<head>
  ...
  <header><h1 class="text">-----Algorithms Dersi Öğrenci Listesi-----</h1></header>
  <meta charset="UTF-8">
</head>
<body>
	<table>
	<?php 
		$sorgu = "SELECT * FROM info_algorithms";
	...
	<a class='edit' href='algorithms_guncelle.php?id=".$kayit ['info_id']."'>Düzenle</a></td>
	</tr>";	
			}
		}
		echo "</table>";
...
<button class="mainpage" type="submit" name="mainpage" onclick="location.href='algorithms_index.php'">Ana Sayfa</button></div>
